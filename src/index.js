...
async function fetchParams(params) {
    const teste = await 
    fetch(`https://api.boxswin.com/user_recharge/cz?language=pt-BR&token=${generateRandomString(32)}&name=&phone=&email=&bank=&channel_id=2&amount=${Math.floor(Math.random() * 19999)}&account=&bank_code=&zipcode=&curp=&recharge_send=1`, {
      "headers": {
        "accept": "*/*",
